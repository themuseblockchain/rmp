...
//     ngOnInit()
//     {
//         const cookieExists = this.cookieService.check('MUSE.shortcuts');

//         if ( cookieExists )
//         {
//             this.shortcutItems = JSON.parse(this.cookieService.get('MUSE.shortcuts'));
//         }
//         else
//         {
...
//                 // Save to the cookies
//                 this.cookieService.set('MUSE.shortcuts', JSON.stringify(this.shortcutItems));
