...
//     displayedColumns = ['id', 'museId', /*'name',*/ 'email', 'permissions', 'status', 'validated'];
...
//     ngOnInit()
//     {
//         this.dataSource = new FilesDataSource(this.contentService, this.paginator, this.sort);
...
//     {
//         super();
//         this.filteredData = this.contentService.content;
//     }
...
//             let data = this.contentService.content.slice();
